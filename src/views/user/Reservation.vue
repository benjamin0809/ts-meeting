  ...
  <div class="user-activity">
    <div class="post">
      ...
      <ul class="list-inline">
        ...
        <li>
          <span class="link-black text-sm">Like</span>
        </li>
      </ul>
    </div>
    <div class="post">
...
export default class extends Vue {
  ...
  carouselPrefix = '?imageView2/2/h/440'
  carouselImages = [
  ...
  mounted() {
    const monthData = this.getMeetingRoomData('2020-01')
  }

  // 获得个人会议室预定记录
  async getMeetingRoomData(month: string) {
    try {
      const data = await RoomApi.GetHomeData(month)
      console.log(data)
      data.forEach(item => {
        const schedulerItem = {
          id: item.RecID,
